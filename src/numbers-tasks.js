...
function getAverage(value1, value2) {
  if (!Number.isFinite(value1) || !Number.isFinite(value2)) {
    throw new Error('Invalid input: One or both numbers are not finite.');
  }
...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  ...
  const cosTheta = vector / (module1 * module2);
...
function getSumOfNumbers(x1, x2, x3) {
  function areNumbersApproximatelyEqual(x, y, tolerance = 1e-10) {
